 ...
 */
public class AnimationBlockCircle extends AnimationBlockShape {

    public static final String ID = "blocks.circle";

    private final int radius;

    public AnimationBlockCircle(Duration duration, @NotNull Location location, @NotNull List<Material> materials, double radius) {
    ...
    public static @NotNull AnimationsProvider.AnimationGenerator generator() {
        return (location, data) -> {
            try {
                ...
                return new AnimationBlockCircle(duration, location, materials, radius);
