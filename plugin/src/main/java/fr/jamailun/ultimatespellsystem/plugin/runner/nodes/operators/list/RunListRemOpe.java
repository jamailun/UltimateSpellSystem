...
/**
 * "Remove" operation on a collection.
 */
public class RunListRemOpe extends ListOperator {

    public RunListRemOpe(@NotNull RuntimeExpression left, @NotNull RuntimeExpression right) {
        super(left, right);
    }
